# edgeR time course analysis for SW016789-treated samples
...
tmm_cpm <- cpm(y, normalized.lib.sizes = TRUE, log = T)
...
write.table(tmm_avg_wide, file = "output/dmso_sw_log2_avg_tmms.txt", sep = "\t", row.names = F)
